\chapter[Software]{Software}
	...
	Com Docker podemos empacotar e executar a aplicação em um ambiente isolado de container. Esse isolamento permite que rodemos múltiplos containeres simultaneamente em uma mesma máquina hospedeira, simulando um ambiente distribuído para os microserviços da nossa aplicação.
